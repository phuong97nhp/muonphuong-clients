                ...
                <form method="POST" action="{{url('/post-add-order')}}">
                    ...
                    <div class="row p-2">
                        <div class="form-group col-12">
                            <label class="label" for="address_customer">Địa chỉ tạo đơn vận:<span
                        ...
                        <div class="form-group col-3">
                            <label class="label" for="">Địa chỉ<span
                                    class="text-danger text-weight-600">(*)</span></label>
                        ...
                        <div class="form-group col-3">
                            <label class="label" for="ward">Xã/Phương:<span
                                    class="text-danger text-weight-600">(*)</span></label>
                        ...
                        <div class="form-group col-3">
                            <label class="label" for="type">Loại dịch vụ:<span
                                    class="text-danger text-weight-600">(*)</span></label>
                        ...
                        <div class="form-group col-3">
                            ...
                            <select name="payments" class="form-control rounded
                                ...
                                <option {{(old('payments') == 'Cuoi thang')?'selected':''}} value="Cuoi thang">Cuối
                                    tháng</option>
                            </select>
                        ...
                        <div class="form-group col-3">
                            <label class="label" for="weight">Trọng lượng<span
                                    class="text-danger text-weight-600">(*)</span></label>
                        ...
                        <div class="form-group col-3">
                            <label class="label" for="phone_b2c">Điện thoại người nhận<span
                                    class="text-danger text-weight-600">(*)</span></label>
                    ...
                    <div class="row p-2">
                        <div class="form-group col-md-12">
                            ...
                            <select required name="address_customer" class="form-control rounded form-control-sm">
                                ...
                                @if ($arrData["address"])
                                @foreach ($arrData["address"] as $key => $item)
                                <option {{Auth::user()["address_id"]==$key?'selected':'' }} value="{{ $key }}">
                                    {{ $item }}</option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-12">
                            <label class="label" for="">&nbsp;</label>
                            <button type="submit" class="btn btn-sm"><i class="fas fa-upload"></i> Tải lên đơn
                                vận</button>
                            <a class="d-flex justify-content-center mt-2" target="_back"
                                href="{{asset('public/excel/excel-import-customer.xlsx')}}">Tải về mẫu Excel</a>
                        </div>
                    </div>
                </form>
            </div>
