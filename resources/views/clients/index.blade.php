...
<link rel="stylesheet" href="{{asset('public/clients/my/styles/cpn.css')}}">
...
<body> 
    <header id="headerContainer" class="container-fluid">
        <nav id="mainMenu" class="row">
            ...
            <ul class="nav col">
                <li class="nav-item">
                    <a class="nav-link active" href="#"> <img id="logo" src="{{asset('public/clients/images/logo.png')}}" alt="Logo
                                azexpress.com.vn/"></a>
                </li>
